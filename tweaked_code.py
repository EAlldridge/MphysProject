...
GLOBAL_INHIBITON = True
IMMUNE_INCERASE = True
...
class Microbe:
    ...
    def inhibit(self, ca125_objects):
        if GLOBAL_INHIBITON == True:
            if self.species == "Good_Bacteria_1" and JENSII == True:
                self.inhibition = False 
            elif calculate_local_concentration(self.location, ca125_objects) > THRESHOLD_CA125:
